...
import test.srz.com.switchfragment.adapter.LazyFragmentPagerAdapter;
import test.srz.com.switchfragment.adapter.LazyPagerAdapter;
import test.srz.com.switchfragment.adapter.LazyViewPagerAdapter;


/**
 * ViewPager that add mItems lazily in the two following situation:
 * <ul>
 *     <li>its mAdapter inherits from {@link LazyViewPagerAdapter}</li>
 *     <li>its mAdapter inherits from {@link LazyFragmentPagerAdapter} and Fragment implements {@link LazyFragmentPagerAdapter.Laziable} </li>
 * </ul>
 */
        ...
        extends ViewPager
{
    ...
    public void setAdapter(PagerAdapter adapter) {
        ...
        mLazyPagerAdapter = adapter != null && adapter instanceof LazyPagerAdapter
                            ? (LazyPagerAdapter) adapter : null;
    }
